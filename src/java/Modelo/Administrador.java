...
public class Administrador {
    ...
    public Administrador(int id, String nombre, String apell, String num_doc, String fech_nac, String ciud_nac, String barr_res, String direc_res, String edad, String genero, String rh, String eps, String telefono, String correo, String cargo, String usuario, String contras) {
        this.id = id;
        this.nombre = nombre;
        this.apell = apell;
