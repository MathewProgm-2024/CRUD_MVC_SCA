...
<body>
    ...
    <div class="cuadro">
        ...
        <div class="contenedor">
            <form class="row" action="Controlador_Curso">
                <div class="col-3">
                    <label for="codigo" class="form-label">Código del curso</label>
                    <input type="text" class="form-control" id="codigo" placeholder="Código" name="txtCodigo">
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" name="accion"><i class="bi bi-floppy2-fill"></i> Agregar</button>
                    </div>
                    <div class="col-2">
